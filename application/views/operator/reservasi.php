    ...
    <div class="card mb-3">
          ...
          <div class="card-body">
            <div class="table-responsive">
              <a class="btn btn-outline-primary " href="new_reservasi_tambah">Add <i class="fa fa-plus"></i></a><br>
              ...
              <td>
                ...
                <?php
                        if ($r->status_reservasi == 0) { ?>
                         ...
                         <a  class="btn btn-success" href="<?php echo base_url().'operator/new_reservasi_in/'.$r->id_reservasi?>/1">Check-IN</a> 
                        <?php
                        }
                        else if ($r->status_reservasi == 1) { ?>
                           <a  class="btn btn-outline-danger" href="<?php echo base_url().'operator/new_reservasi_out/'.$r->id_reservasi?>/2"> Check-OUT</a> 
                           <a  class="btn btn-outline-success" href="<?php echo base_url().'operator/new_reservasi_perpanjang/'.$r->id_reservasi?>">PERPANJANG</a> 
                        <?php
                        }
                        else { ?>
                          <span class="label label-success">TELAH CHECK-OUT</span>
                        <?php
                        }
                        ?>
              </td>
