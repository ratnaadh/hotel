        ...
        <div class="text-black font-weight-bold center">
            ...
            <?php
                if ($value['status_kamar']=="0") { ?>
                  <div class="card-body bg-primary status sold">
                ...
                <div style="color: white;">KAMAR TELAH TERISI</div>
              </div>
              <?php 
              }
              ?>

                <h3><a class="text-primary" href="<?php echo base_url();?>welcome/kamardetail/<?php echo $value['id_kamar'];?>"><?php echo $value['no_kamar'];?></a></h3>
                  ...
                  <a class="btn btn-primary bg-primary" href="<?php echo base_url();?>welcome/kamardetail/<?php echo $value['id_kamar'];?>">Detail</a>
