...
<div class="row">
    ...
    <div class="col-lg-3 col-sm-4 hidden-xs">
          <div class="search-form"><h4><span class="fa fa-search"></span>Cari kamar</h4>
              ...
              <button class="btn btn-primary bg-primary">Cari</button>
...
<p class="price text-primary" ><?php echo rupiah($harga_kamar);?></p>
...
<div class="enquiry">
    ...
    <input type="hidden" name="id_kamar" value="<?php echo $id_kamar;?>">
     <div class="input-group date form_date col-md-12" data-date="" data-date-format="dd/mm/yyyy" data-link-field="dtp_input2" data-link-format="yyyy-mm-dd">
       <span class="input-group-addon"><span class="fa fa-calendar"></span></span>
                                                            <input class="form-control"  type="text" name="tgl_reservasi_masuk" placeholder="Check-in" autocomplete="off">
      ...
      <div class="input-group date form_date col-md-12" data-date="" data-date-format="dd/mm/yyyy" data-link-field="dtp_input2" data-link-format="yyyy-mm-dd">
       <span class="input-group-addon"><span class="fa fa-calendar"></span></span>
                                                            <input class="form-control"  type="text" name="tgl_reservasi_keluar" placeholder="Check-out" autocomplete="off">

                                            

                                                        </div>
                                                        <br>
                <input type="text" class="form-control" name="nama_reservasi" placeholder="Nama Lengkap"/>
                <input type="number" class="form-control" name="tlp_reservasi" placeholder="Nomor Telepon"/>
                <textarea rows="6" class="form-control" name="alamat_reservasi" placeholder="Alamat Lengkap"></textarea>
      <button type="submit" class="btn btn-primary bg-primary" name="Submit">Booking</button>
  ...
  <div class='alert alert-danger'>
                                           <span>Kamar telah terisi, Silahkan pilih kamar lain</span>  
                                        </div>
