              ...
              <td>
                ...
                <?php
                        if ($r->status_reservasi == 0) { ?>
                         ...
                         <a  class="btn btn-outline-success" href="<?php echo base_url().'admin/new_reservasi_in/'.$r->id_reservasi?>/1">Check-IN</a> 
                        <?php
                        }
                        else if ($r->status_reservasi == 1) { ?>
                           <a  class="btn btn-outline-danger" href="<?php echo base_url().'admin/new_reservasi_out/'.$r->id_reservasi?>/2">Check-OUT</a> 
                           <a  class="btn btn-outline-primary" href="<?php echo base_url().'admin/new_reservasi_perpanjang/'.$r->id_reservasi?>">PERPANJANG</a> 
                        <?php
                        }
                        else { ?>
